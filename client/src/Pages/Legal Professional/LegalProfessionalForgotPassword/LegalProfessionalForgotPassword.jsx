...
function LegalProfessionalForgotPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Call the resetPasswordLegalProfessional API with the provided email and password
      ...
      if (response.success) {
        ...
        setTimeout(() => {
          navigate('/legal-professional-login'); // Redirect to the Legal Professional login page
        }, 3000);
      } else {
    ...
    <div className="container">
      ...
      <div className="row vh-75 my-5">
        <div className="col-md-6 d-grid my-5">
          <img src={CoolGirl} className="img-fluid m-1 align-self-center" alt="Legal Professional" />
        </div>
...
export default LegalProfessionalForgotPassword;
