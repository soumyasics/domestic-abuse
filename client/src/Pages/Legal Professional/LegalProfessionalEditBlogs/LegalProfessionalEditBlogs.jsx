...
function LegalProfessionalEditBlogs() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (validate()) {
            // Perform the edit blog action
            console.log("Blog edited successfully", formValues);
        }
    };
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className='row m-5'>
                            ...
                            <div className='col-4 text-end'>
                                <button type='submit' className='btn text-white bg-purple py-2 px-5'>Save</button>
                            </div>
                            <div className='col-4 text-end'>
...
export default LegalProfessionalEditBlogs;
