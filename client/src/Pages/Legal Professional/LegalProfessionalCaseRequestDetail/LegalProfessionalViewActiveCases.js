...
function LegalProfessionalViewActiveCases() {
          ...
          const fetchAppointments = useCallback(async () => {
            try {
              const response = await viewLPAprvdAppointments(localStorage.getItem('lpId'));
                          ...
                          <tr key={appointment._id}>
                            ...
                            <td className=''>
                              ...
                              <Link
                                  ...
                                  className="m-2 px-5"
                                 to={`/legal-professional-view-active-case-details/${appointment._id}`}
                                >
                                  View Details
                                </Link>
...
export default LegalProfessionalViewActiveCases