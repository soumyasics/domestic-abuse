...
import { viewCounsellorAppointments, acceptAppointmentById, rejectAppointmentById, acceptCouncAppointmentById, rejectCouncAppointmentById, viewLPAppointments, acceptLPAppointmentById, rejectLPAppointmentById } from '../../../Services/apiService';
...
function LegalProfessionalViewCases() {
      ...
      const fetchAppointments = useCallback(async () => {
        try {
          const response = await viewLPAppointments(localStorage.getItem('lpId'));
                      ...
                      <tr key={appointment._id}>
                        ...
                        <td className=''>
                          ...
                          <Link
                              ...
                              className="m-2 px-5"
                             to={`/legal-professional-view-case-details/${appointment._id}`}
                            >
                              View Details
                            </Link>
...
export default LegalProfessionalViewCases