import React, { useState } from 'react';
    ...
    import { resetPwdCouncellor } from '../../../Services/apiService';
    
function CouncellorResetPwd() {
            ...
            const handleSubmit = async (e) => {
                ...
                try {
                      const response = await resetPwdCouncellor(localStorage.getItem('counsellorId'),changePassword);
...
export default CouncellorResetPwd