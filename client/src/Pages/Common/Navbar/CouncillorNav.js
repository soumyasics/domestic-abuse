...
function CouncillorNav() {

    const navigate = useNavigate();

    useEffect(() => {
        if (localStorage.getItem("counsellorId") == '')
            navigate('/');
    }, []);
    const handleLogout = () => {
        localStorage.setItem('counsellorId', '')
        navigate('/');
    };
                ...
                <div className="collapse navbar-collapse mx-5 justify-content-end" id="navbarNav">
                    <ul className="navbar-nav ml-auto mx-5">
                        <li className="nav-item active">
                            ...
                            <Link className="nav-link mx-3 theme-purple fw-semibold" to="/counsellor-home">Home</Link>
                            {/* )} */}
                        </li>
                        {/* <li className="nav-item active">
                                    {isLoggedIn && userRole === 'supporter' ? (
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown1">
                                <li><Link className="dropdown-item theme-purple fw-semibold" to="/counsellor-add-blogs">Add New</Link></li>
                                <li><Link className="dropdown-item theme-purple fw-semibold" to="/counsellor-view-blogs">View All</Link></li>
                            </ul>
                        </li>
                        <li className="nav-item dropdown">
