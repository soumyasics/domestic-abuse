...
import './SupporterForgotPassword.css';
...
function SupporterForgotPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    toast.success("Accepted Request Redirecting to Home Page");
        ...
        <div className="col-md-6 text-center d-grid align-self-center my-5">
          ...
          <form onSubmit={handleSubmit} noValidate>
            <div className="row m-4 mb-0 text-start">
              <div className="col">
                <div className="input-group">
                  <input type="text" id="username" className={`form-control form-control-lg border home-card-bg rounded-4 ${errors.email ? 'is-invalid' : ''}`} placeholder="Email" value={email} onChange={(e) => setEmail(e.target.value)} />
            ...
            <div className="row m-4 mb-0 text-start">
              <div className="col">
                <div className="input-group">
                  <input type={passwordShown1 ? "text" : "password"} id="password" className={`form-control form-control-lg border border-end-0 rounded-end-0 home-card-bg rounded-4 ${errors.password ? 'is-invalid' : ''}`} placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)} />
            ...
            <div className="row m-4 mb-0 text-start">
              <div className="col">
                <div className="input-group">
                  <input type={passwordShown2 ? "text" : "password"} id="confirmPassword" className={`form-control form-control-lg border border-end-0 rounded-end-0 home-card-bg rounded-4 ${errors.confirmPassword ? 'is-invalid' : ''}`} placeholder="Confirm Password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} />
            ...
            <div className="row m-5">
              <div className="col">
                <button type="submit" className="btn bg-theme btn-lg fw-bolder px-5 text-white rounded-pill" >Submit</button>
              </div>
            </div>
          </form>
        </div>
...
export default SupporterForgotPassword;
