...
import { resetPwdSupp } from '../../../Services/apiService';


function SupporterResetPwd() {
        ...
        const handleSubmit = async (e) => {
            ...
            try {
                  const response = await resetPwdSupp(localStorage.getItem('supporterId'),changePassword);
...
export default SupporterResetPwd